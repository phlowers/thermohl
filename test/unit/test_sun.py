...
def test_scalar_input():
    ...
    # utc2solar_hour(datetime_utc, longitude)
    dt = datetime(2025, 5, 18, 12, 30, 45)
    longitude = np.deg2rad(45)  # 45 degrees east

    result = utc2solar_hour(dt, longitude)
...
def test_array_input():
    ...
    lons = np.deg2rad(np.array([0, 90, 135]))

    result = utc2solar_hour(dts, lons)
