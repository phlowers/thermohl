...
def test_max_len_with_ndarray():
    dic = {"latitude_deg": np.array([45.0, 46.0]), "lon": np.array([10.0, 11.0])}
    args = Args(dic)
...
def test_max_len_with_scalar():
    dic = {"latitude_deg": 45.0, "lon": 10.0}
    args = Args(dic)
...
def test_extend_to_max_len_with_nd_array():
    dic = {"latitude_deg": np.array([45.0, 46.0]), "lon": 10.0}
    args = Args(dic)
...
def test_compress_with_unique_values():
    dic = {"latitude_deg": np.array([45.0, 45.0]), "lon": np.array([10.0, 10.0])}
    args = Args(dic)
