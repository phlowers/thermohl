...
class Args:
    ...
    # __slots__ = [
    #     'latitude', 'longitude', 'altitude', 'cable_azimuth', 'month', 'day', 'hour', 'ambient_temperature', 'ambient_pressure', 'relative_humidity', 'precipitation_rate', 'wind_speed', 'wind_angle', 'albedo', 'turbidity', 'transit', 'm',
