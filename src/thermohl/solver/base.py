...
class Args:
    ...
    #     'core_diameter_m', 'outer_diameter_m', 'core_area_m2', 'outer_area_m2', 'roughness_ratio', 'l', 'c', 'alpha', 'epsilon', 'RDC20', 'magnetic_coeff', 'magnetic_coeff_per_a', 'temperature_coeff_linear', 'kq', 'RDCHigh', 'RDCLow',
    #     'THigh', 'TLow'
    # ]
